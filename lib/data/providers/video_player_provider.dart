...
class VideoPlayerProvider {
  List<VideoPlayerModel> getVideos() {
    return [
      VideoPlayerModel(
        videoUrl: "assets/videos/video_1.mp4",
        name: "Vannak Niza🦋",
        caption: "Morning, everyone!!",
        songName: "original sound - Ly Chan",
        profileImg:
      ...
      VideoPlayerModel(
        ...
        name: "Dara Chamroeun",
        caption: "Oops 🙊 #fyp #comtiktok",
        songName: "original sound - 💛💛 now🌟",
        profileImg:
      ...
      VideoPlayerModel(
        ...
        caption: "#블루모드",
        songName: "original sound - 🖤 Kun Generation",
        profileImg:
